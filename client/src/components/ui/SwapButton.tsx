...
export function SwapButton({
  ...
  const pill = cn(
    'inline-flex min-w-0 items-center justify-center whitespace-nowrap rounded-[30px] bg-[#3E7FB1] font-semibold leading-[1.3] text-white no-underline transition-colors duration-300 group-hover:bg-[#5FAF6B]',
    compact
  ...
  const chip = cn(
    'inline-flex shrink-0 items-center justify-center rounded-full bg-[#3E7FB1] text-white transition-colors duration-300 group-hover:bg-[#5FAF6B]',
